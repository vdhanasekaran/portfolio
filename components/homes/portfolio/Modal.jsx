                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <h3 className="portfolio-modal-table-text">
                      ...
                      Methodology : <span>{modalContent?.methodlogy}</span>
                    </h3>
                  </div>
                  <div className="col-md-6">
                    <h3 className="portfolio-modal-table-text">
                      ...
                      Tech stack :{" "}
                      <span>{modalContent != undefined ? modalContent["Tech stack"].join(", "): ''}</span>
                    </h3>
                  </div>
                  <div className="col-md-6">
                    <h3 className="portfolio-modal-table-text">
                      ...
                      Preview :{" "}
                      <a href={modalContent?.previewLink} target="__blank">
