export const menuItems = [
  ...
  { id: 4, href: "/blog", icon: "fa-brands fa-blogger", text: "Certificates" },
  {
    id: 5,
    href: "/contact",
...
export const menuItemsTwo = [
  ...
  { id: 4, href: "/blog-2", icon: "fa-brands fa-blogger", text: "Certificates" },
  {
    id: 5,
    href: "/contact-2",
    icon: "size-22 fa-light fa-address-book",
...
export const menuItemsThree = [
  ...
  { id: 4, href: "/blog-3", icon: "fa-brands fa-blogger", text: "Certificates" },
  {
    id: 5,
    href: "/contact-3",
    icon: "size-22 fa-light fa-address-book",
